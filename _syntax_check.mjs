...
// ?ï¿?ï¿?helpers ?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?const H_JSON = { "Content-Type": "application/json; charset=utf-8" };
...
// ?ï¿?ï¿?watchlist + candle helpers ?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?let _watchCache = null;
let _watchCacheAt = 0;
...
// ?ï¿?ï¿?handlers: health & basic CRUD ?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?async function healthz(request) {
  let dbOk = false;
...
async function warmingZoneScan(request) {
  ...
  const items = results
    ...
    .map((r) => ({ ...r, category: r.score >= 4 ? "å¼·å‹¢" : "è½‰å¼·" }));
  return json({
...
// ?ï¿?ï¿?new handlers: market_gaps, fibonacci, scan_and_email ?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?async function computeGapsForSymbol(symbol, label, lookback, minGap) {
  try {
    const { rows } = await q(
...
// ?ï¿?ï¿?new handlers: etf_holdings/* ?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?async function etfList(request) {
  try {
...
// ?ï¿?ï¿?new handlers: rebalance/* ?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?async function rebalanceCompute(request) {
  const watch = await getWatchMap();
  const codes = Array.from(watch.keys());
...
// ?ï¿?ï¿?new handlers: uptrend_watch/* ?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?async function uptrendWatch(request) {
...
// ?ï¿?ï¿?new handlers: admin/logs (markers as log) ?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?async function adminLogs(request, id) {
  try {
    if (id) {
...
// ?ï¿?ï¿?new handlers: conference, exdiv, etc. ?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?async function conferenceList(request) {
  const u = urlOf(request);
...
// /api/conference/<code> ??per-stock conference / æ³•èªª??lookup. Frontend
...
// ?ï¿?ï¿?institutional / foreign_futures / financial / revenue etc. ?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?async function institutionalImpl(request, code) {
  try {
  ...
  try {
    ...
    const sql = `
      SELECT r.id, r.symbol AS code,
             -- ??ä¿®æ­£ BUG-5ï¼šå„ª?ï¿½ç”¨ watchlist ?ï¿½ç¨±ï¼ˆè‡ª?ï¿½è‚¡å·²å‘½?ï¿½ï¿½?ï¼Œfallback ??             --   market_instruments.display_nameï¼ˆï¿½?å¸‚ï¿½??ï¿½ï¿½??ï¿½ï¿½??ï¿½è¡¨ï¼‰ï¿½??ï¿½å?ï¿??ï¿½ç©ºå­—ä¸²??             --   revenue è¡¨ï¿½??ï¿½å…¨å¸‚å ´?ï¿½ç¥¨ï¼Œï¿½? watchlist ?ï¿½ï¿½? 7 ?ï¿½è‡ª?ï¿½è‚¡ï¼Œï¿½???join
...
// ?ï¿?ï¿?sold_too_early: heuristic "potentially sold too early" detector ?ï¿?ï¿?// No trade history. Heuristic: for each watchlist stock, find cases where
...
// ?ï¿?ï¿?price_compare / heatmap ?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?async function priceCompare(request) {
  const u = urlOf(request);
...
// ?ï¿?ï¿?etf_signal_filter / stock_damo_filter / stock_news_scan ?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?async function etfSignalFilter(request) {
  const etfs = await getEtfList();
...
// ?ï¿?ï¿?etf_pivot/* real handlers ?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?async function etfPivotOverlap(request) {
  const u = urlOf(request);
...
// ?ï¿?ï¿?single-resource GETs (markers/<id>, recipients/<id>, etc.) ?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?async function markerById(request, id) {
...
// ?ï¿?ï¿?data loaders (fetch from TWSE public API ??insert into Neon) ?ï¿?ï¿?ï¿?ï¿?function twseDateStr(d) {
...
// ?ï¿?ï¿?overseas indices loader (Yahoo Finance unofficial chart API) ?ï¿?ï¿?// Symbols cover: S&P 500, Dow, Nasdaq, Nikkei, KOSPI, Hang Seng, CSI 300, FTSE, DAX, CAC 40.
...
// ?ï¿?ï¿?loadMacroYields: Yahoo Finance US Treasury yields ??macro_yields ?ï¿?// Series mapping:
...
// ?ï¿?ï¿?loadMacroNews: Google News RSS ??knowledge_library (record_type=news) ?ï¿?async function loadMacroNews(request) {
  const u = urlOf(request);
  const body = request.method !== "GET" ? await readJson(request) : {};
  if (request.method === "POST" && !operatorOk(body?.password, request)) {
    return json({ error: "å¯†ç¢¼?ï¿½èª¤" }, { status: 403 });
...
// ?ï¿?ï¿?loadIndexInstitutional: TWSE å¤§ç›¤ ä¸‰å¤§æ³•äºº ??index_institutional ?ï¿?// Endpoint: https://www.twse.com.tw/fund/BFI82U?response=json&dayDate=YYYYMMDD
...
// ?ï¿?ï¿?loadMarkers: ï¿?screener + market_price_bars ?ï¿½ï¿½?å¯«å…¥ markers (è²·è³£è¨Šï¿½?) ?ï¿?// è¦ï¿½?ï¼ˆç°¡?ï¿½ï¿½?ï¼Œï¿½? seed ?ï¿½ï¿½??ï¿½å®¹?ï¿½ï¿½??ï¿½ï¿½?:
...
// ?ï¿?ï¿?FinMind loaders (big_holders + financial_reports) ?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?// ?ï¿?$env:FINMIND_TOKEN, ??token ??fallback synth_v2_60 (è·‘ç¾??seed script)
...
// ?ï¿?ï¿?loadMarketPrices: TWSE STOCK_DAY_ALL ??market_price_bars ?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?// Refreshes the latest trading day's close for all stocks in watchlist +
...
// ?ï¿?ï¿?loadMarketPricesFinMind: FinMind TaiwanStockPrice ??market_price_bars ?ï¿?ï¿?// 2026-08-13: backup source for ?ï¿½è‚¡ OHLC (free, no token needed).
...
// ?ï¿?ï¿?loadAllCombined: combined loader for Vercel Hobby (1 cron slot) ?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?// Runs: macro_yields ??macro_news ??index_institutional ??market_prices ??sectors ??markers ??ai_capex
...
async function loadAllCombined(request) {
  ...
  // 5. sectors (ç¡¬ç·¨ TWSE industry mapping)
...
// ?ï¿?ï¿?loadMarketPricesBackfill: Yahoo Finance ?ï¿½è‚¡?ï¿½æ­·????market_price_bars ?ï¿?// One-shot: pulls 1y of daily bars per stock in watchlist so the screener
...
// ?ï¿?ï¿?MOPS revenue loader (?ï¿½ï¿½???from ?ï¿½ï¿½?è³‡ï¿½?è§€æ¸¬ï¿½?) ?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?// Flow:
...
// ?ï¿?ï¿?TAIFEX futures loader (å¤§å°/å°å°/?ï¿½ï¿½?/?ï¿½ï¿½?/å¾®ï¿½?) ?ï¿?ï¿?// Endpoint: https://www.taifex.com.tw/cht/3/dlFutDataDown?down_type=1&commodity_id=<TX>&queryStartDate=YYYY/MM/DD&queryEndDate=YYYY/MM/DD
// CSV: Big5 encoded. Columns: äº¤ï¿½??ï¿½ï¿½?,å¥‘ï¿½?,?ï¿½ï¿½??ï¿½ä»½(?ï¿½åˆ¥),?ï¿½ç›¤???ï¿½é????ï¿½ä????ï¿½ç›¤??æ¼²ï¿½???æ¼²ï¿½?%,?ï¿½äº¤??çµï¿½????ï¿½ï¿½??ï¿½ï¿½?ç´„æ•¸,...
...
// ?ï¿?ï¿?ai_capex loader: SEC EDGAR companyconcept API ??ai_capex table ?ï¿?ï¿?ï¿?ï¿?ï¿?// Companies: NVDA / MSFT / AMZN / GOOGL / META / ORCL (TSM is 20-F, skipped)
...
// ?ï¿?ï¿?etf_holdings loader: per-issuer scraping (PROBE ONLY) + manual seed ?ï¿?ï¿?// Per-issuer scraping not viable: yuanta.com.tw / cathaysite.com.tw /
...
// ?ï¿?ï¿?seedBigHolders: manual POST endpoint for big_holders ?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?// Body: { password, holders: [{ symbol, holder_type, holder_name, shares, pct, as_of_date }] }
...
// ?ï¿?ï¿?seedFinancialReports: manual POST endpoint for financial_reports ?ï¿?ï¿?// Body: { password, reports: [{ symbol, period, revenue, gross_profit, operating_income, net_income, eps, source }] }
...
// ?ï¿?ï¿?placeholders (return helpful shape, not pure stub) ?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?function placeholder(name, hint) {
...
// ?ï¿?ï¿?router ?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?const TABLE = [
