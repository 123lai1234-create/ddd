...
const Sound = (() => {
  ...
  const BGM = {
    ...
    dungeon: {
      bpm: 58,
      notes: [138, 155, 174, 196, 207, 233, 261, 277],
      pattern: [0, -1, 2, -1, 1, 3, 0, -1, 5, -1, 4, -1, 2, 3, 1, 0],
      bass:    [0, -1, 0, -1, 5, -1, 3, -1, 0, -1, 5, -1, 3, -1, 0, -1],
    },
    shrine: {
      bpm: 72,
      notes: [261, 311, 349, 392, 466, 523, 587, 659],
      pattern: [0, 2, 4, 6, 4, 2, 0, -1, 1, 3, 5, 7, 5, 3, 1, -1],
